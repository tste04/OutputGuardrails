...
| **Security** | `SecretsCheck` (Zugangsdaten) + `ExfiltrationCheck` (Abflusskanäle, Injection-Echo, zerstörerische Befehle) | `SEC-001`…`SEC-009`, `EXF-001`…`EXF-004` | Neubau; SEC-IDs deckungsgleich mit AIGateway |
